...
class FlutterOverlayWindow {
  ...
  static Future<bool?> updatePosition(int x, int y) async {
    final bool? _res = await _overlayChannel.invokeMethod<bool?>(
      'updatePosition',
      {
        'x': x,
  ...
  /// Update the touchable region of the overlay.
  /// Touches outside this region will be passed to the background.
  static Future<bool?> updateTouchableRegion(int left, int top, int right, int bottom) async {
    final bool? _res = await _overlayChannel.invokeMethod<bool?>(
